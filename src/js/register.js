...
const submitBtn = document.getElementById("registerSubBtn");
...
function stateAction(action) {
  const error = `<div
      ...
      >
        ...
        <div class="ms-3 text-sm font-normal">Nimadir xato, qayta urinib ko'ring.</div>
        <button
          type="button"
  ...
  const success = `<div id="toast-success" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
    ...
    <div class="ms-3 text-sm font-normal">Muvafaqqiyatli ro'yxatdan o'tdingiz</div>
...
async function register(data) {
  const res = await fetch(
    "https://json-api.uz/api/project/fn34/auth/register",
    {
      method: "POST",
      headers: {
